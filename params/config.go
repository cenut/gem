...
var (
	MainnetGenesisHash = common.HexToHash("0x91078f5f3e890a4311949c74597c0ca9bb4618b53f2a534fa97c0b0c7bb2b19e") // old: 0xd4e56740f876aef8c010b86a40d5f56745a118d0906a34e69aec8c0db1cb8fa3
...
var (
	...
	MainnetChainConfig = &ChainConfig{
		...
		ByzantiumBlock:      big.NewInt(0),  	  // reward Halved.
		ConstantinopleBlock: big.NewInt(977941176), // Block reward is 0.
	...
	TestnetChainConfig = &ChainConfig{
		...
		ByzantiumBlock:      big.NewInt(42),  // reward Halved. reward: 2.5
		ConstantinopleBlock: big.NewInt(80),  // Block reward is 0. reward: 1.25
		Ethash:              new(EthashConfig),
	}
...
// IsStatusFork returns whether num is either equal to the Status fork block or greater.
func (c *ChainConfig) IsStatusFork(num *big.Int) bool {
