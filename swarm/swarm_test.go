...
func TestParseEnsAPIAddress(t *testing.T) {
	for _, x := range []struct {
	...
	}{
		{
			...
			value:       "/data/testnet/gem.ipc",
			endpoint:    "/data/testnet/gem.ipc",
		},
		{
		...
		},
		{
			...
			value:       "test:/data/testnet/gem.ipc",
			endpoint:    "/data/testnet/gem.ipc",
			tld:         "test",
		},
		{
		...
		},
		{
			...
			value:       "314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/gem.ipc",
			endpoint:    "/data/testnet/gem.ipc",
		...
		},
		{
			...
			value:       "test:314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/gem.ipc",
			endpoint:    "/data/testnet/gem.ipc",
			addr:        common.HexToAddress("314159265dD8dbb310642f98f50C066173C1259b"),
			tld:         "test",
		},
