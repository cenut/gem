...
// Create creates a new contract using code as deployment code.
func (evm *EVM) Create3(contract common.Address, caller ContractRef, code []byte, gas uint64, value *big.Int) (ret []byte, contractAddr common.Address, leftOverGas uint64, err error) {
	return evm.create(caller, code, gas, value, contract)
}
