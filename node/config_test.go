...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gem.ipc", false, filepath.Join(os.TempDir(), "gem.ipc")},
		{"data", "gem.ipc", false, "data/gem.ipc"},
		{"data", "./gem.ipc", false, "./gem.ipc"},
		{"data", "/gem.ipc", false, "/gem.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gem.ipc", true, `\\.\pipe\gem.ipc`},
		{"data", "gem.ipc", true, `\\.\pipe\gem.ipc`},
		{"data", `\\.\pipe\gem.ipc`, true, `\\.\pipe\gem.ipc`},
	}
