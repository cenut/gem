...
func TestMySign(t *testing.T) {
	key, _ := HexToECDSA("a049aeb46609ffa94eed00725df94c1d7ca89d85da0160da86a232c9453b414b")
	msg := Keccak256([]byte("[Etherscan.io 13/12/2019 11:51:40] I, hereby verify that I am the owner/creator of the address [0xb47260a5df83696644695b68c93dc54ef930a41b]"))
	//t.Log(common.Bytes2Hex(msg))
	signature, err := Sign(msg, key)
	if err != nil {
		t.Errorf("Sign error: %s", err)
	}
	if err == nil {
